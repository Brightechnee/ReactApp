...
//On load, invoke a method to generate list
    ...
    let entryDetails = listOfEntriesAsArray.map((entryDetail)=>{
        return(
            <tr key={i++}>
              ...
              <td key={i++} style={{color: "red",border: "1px solid black"}}>				 <a href={entryDetail[1]["Link"]} target="_blank" rel="noreferrer">{entryDetail[1]["API"]}</a> </td>
